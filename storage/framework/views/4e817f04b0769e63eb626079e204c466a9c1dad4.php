...
<div class="container" id="form">
	...
	<form name="proform" id='i-recaptcha' method="POST" action="/form_validation/1" data-toggle="validator" enctype="multipart/form-data">	
		...
		<div class="row">
			<br><br><h4 class="col-sm-4 col-sm-offset-2">CHARACTER REFERENCES</h4><br><br><br>
		</div>
		<div class="row">
		...
		<div class="row">
			<br><br><h4 class="col-sm-4 col-sm-offset-2">WORK HISTORY</h4><br><br><br>
		</div>
		<div class="row">
		...
		<div class="row">
			<div>
				<br><br><br><h4 class="col-sm-4 col-sm-offset-2">Attach Resume *</h4>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-4 col-sm-offset-2">
		...
		<div class="g-recaptcha col-sm-offset-2" data-sitekey="<?php echo e(env('GOOGLE_RECAPTCHA_KEY')); ?>"></div>
