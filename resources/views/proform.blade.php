	...
	<form name="proform" id='i-recaptcha' action="/form_validation/1/{{$vacancy->id}}" method="POST" data-toggle="validator" enctype="multipart/form-data">	
		...
		<div class="row">
			<div class="form-group col-md-3 col-md-offset-2">
	    		...
	    		<input type="text" class="form-control" name="name2" id="name2" placeholder="e.g. Jane Doe" data-error="Please input this field" maxlength="75" value="{!! old('name2') !!}" required>
	    		<div class="help-block with-errors"></div>
	  		</div>
	  		<div class="form-group col-md-2">
