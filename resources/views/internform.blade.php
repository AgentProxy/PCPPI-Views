	...
	<form id='i-recaptcha' method="POST" action="/form_validation/3" data-toggle="validator" enctype="multipart/form-data">
		...
		<div class="row">
		  	<div class="form-group col-md-4 col-md-offset-2">
	    		...
	    		<input type="text" class="form-control" id="fname" name="fname" data-error="Please input your first name" required maxlength="75" value="{!! old('fname') !!}">
		...
		<div class="row">
			<div class="form-group col-md-3 col-md-offset-2">
	  		...
	  		<div class="form-group col-md-3">
	    		...
	    		<input type="email" class="form-control" id="email" name="email" data-error="Please input a valid email address" required maxlength="75" value="{!! old('email') !!}">
	    		<div class="help-block with-errors"></div>
	  		</div>
		</div>	
		<div id="forms-section" class="row">
		...
		<div class="row">
	  		<div class="form-group col-md-8 col-md-offset-2">
	    		...
	    		<input type="text" class="form-control" id="school" name="school" data-error="Please input this field" required maxlength="75" value="{!! old('school') !!}">
    			<div class="help-block with-errors"></div>
	  		</div>
		</div>	
		<div class="row">
	  		<div class="form-group col-md-3 col-md-offset-2">
	    		...
	    		<input type="text" class="form-control" id="course" name="course" data-error="Please input this field" required maxlength="75" value="{!! old('course') !!}">
    			<div class="help-block with-errors"></div>
	  		</div>
	  		<div class="form-group col-md-2">
